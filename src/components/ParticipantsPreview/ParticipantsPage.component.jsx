...
const ParticipantsPage = () => {
    ...
    },
    {
        ...
        אלינה באנק, בוגרת Ma בייעוץ ארגוני. לבעלת ניסיון של למעלה מ 15 שנים בתחומי ההדרכה והלמידה בארגונים עסקיים ומוסדיים  (hertz, בי"ח שערי צדק). כיום מנהלת מח' פיתוצ והערכת הדרכה במכללה הלאומית לשוטרים, מטעם זכיין ההדרכה.`,
